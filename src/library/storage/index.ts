...
/**
 * Initializes the storage with custom parameters.
 *
 * @param displayName The display name for the app, used in storage ID.
 * @param privateKey The private key for encryption.
 */
export function initializeStorage(displayName: string, privateKey: string) {
  AppStorage = new MMKV({
    id: `user-${displayName}-storage`,
